...
$pie = new pData();
$pie->addPoints(array(27,32,12),"ScoreA");
$pie->setSerieDescription("ScoreA","Application A");
$pie->addPoints(array("Mines","Jungle","Ice Caves","Temple","Hell"),"Labels");
$pie->setAbscissa("Labels");

/* Create the pChart object */ 
$myPicture = new pImage(700,230,$pie); 
...
$PieChart = new pPie($myPicture,$pie); 
...
//$myPicture->autoOutput("/images/charts/pie.png"); 
$myPicture->stroke;
?>
